...
import { getAuthLoginUrl } from '@/lib/auth'
    ...
    <div className="min-h-screen bg-obsidian-950 bg-grid flex">
      <div className="hidden lg:flex flex-col justify-between w-[480px] shrink-0 p-10 border-r border-white/6">
        ...
        <div className="text-[10px] text-gray-700">
          Copyright 2025 CognitoBIZ | Built for KeanU Hackathon
        </div>
      </div>
          ...
          <div className="glass-strong rounded-2xl border border-white/8 p-8 shadow-card">
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center">
                <span className="px-3 text-[10px] text-gray-600 bg-obsidian-800">or sign in with Auth0</span>
              </div>
            </div>

            <a
              href={authLoginUrl}
              className="block w-full py-2.5 rounded-xl bg-obsidian-700 border border-white/8 text-gray-300 text-sm text-center hover:border-white/16 hover:bg-obsidian-600 transition-all"
            >
              Continue with Auth0
            </a>

            {auth0Error === 'not_configured' ? (
              <p className="text-center text-[11px] text-ember-300 mt-4">
                Auth0 is not configured on the backend yet. Check your backend Auth0 environment values and restart the backend server.
              </p>
            ) : null}
