...
# # Baseline monthly spend anchors for a seed SaaS company (~$85k/mo burn).
# # Snowflake macro signals scale these up/down based on real economic conditions.
# SEED_SAAS_BASELINE = {
#     "Infrastructure": 5100,
#     "Payroll": 45000,
#     "Marketing": 3400,
...
# # Which Snowflake variable_names map to which spend category and how they
# # influence the benchmark (direction = 1 means higher indicator → higher spend).
# INDICATOR_MAP = [
#     # Employment cost index → Payroll benchmark goes up when labor is expensive
#     {"keywords": ["employment cost", "labor cost", "wages", "compensation"],
#      "category": "Payroll", "direction": 1, "scale": 450},
#     # CPI / inflation → Infrastructure & Software costs rise
#     {"keywords": ["consumer price", "cpi", "inflation", "price index"],
#      "category": "Infrastructure", "direction": 1, "scale": 510},
#     {"keywords": ["consumer price", "cpi", "inflation", "price index"],
#      "category": "Software Subscriptions", "direction": 1, "scale": 220},
#     # Interest rates → Legal / compliance cost proxy (financing activity)
#     {"keywords": ["federal funds", "interest rate", "treasury", "fed rate"],
#      "category": "Legal", "direction": 1, "scale": 38},
#     # GDP growth → Marketing spend benchmark (growth environment)
#     {"keywords": ["gdp", "gross domestic product", "economic growth", "output"],
#      "category": "Marketing", "direction": 1, "scale": 340},
# ]
...
#                 row = rows[0]
#                 return {
#                     "hourly_low": float(row.get("HOURLY_LOW") or 0),
#                     "hourly_avg": float(row.get("HOURLY_AVG") or 0),
#                     "hourly_high": float(row.get("HOURLY_HIGH") or 0),
#                 }
